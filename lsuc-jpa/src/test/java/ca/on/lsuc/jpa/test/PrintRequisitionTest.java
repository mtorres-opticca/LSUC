...
public class PrintRequisitionTest {
	
	    @Autowired
	    private PrintRequisitionRepository dao;
	    
	    
	    @Test
	    public void testCreate() throws Exception {
	    	List<PrintRequisition> printRequisitions = dao.findAll();
	    	assertThat(printRequisitions).hasSize(3);
	    }
